...
Exit codes & warnings:
  ...
  expedia-cars-pp-cli sync

  # Sync specific resources only
  expedia-cars-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  expedia-cars-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  expedia-cars-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  expedia-cars-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  expedia-cars-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/expedia-cars-pp-cli/data.db)")
...
func defaultSyncResources() []string {
	return []string{
		...
		"getconfig",
		"gsi",
		"gsi-fedcm-config-passive-json",
		"gsi-fedcm-listaccounts",
		"maps",
		"maps-api-mapsjs-gen-204",
		"targeting-service",
		"typeahead",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		".well-known": "/.well-known/web-identity",
		"getconfig": "/getconfig/sodar",
		"gsi": "/gsi/status",
		"gsi-fedcm-config-passive-json": "/gsi/fedcm/config/passive.json",
		"gsi-fedcm-listaccounts": "/gsi/fedcm/listaccounts",
		"maps": "/maps/api/js",
		"maps-api-mapsjs-gen-204": "/maps/api/mapsjs/gen_204",
		"targeting-service": "/targeting-service/v3/adinfo",
		"typeahead": "/api/v4/typeahead/Las Vegas, NV, United States of America (LAS-Harry Reid Intl.)",
	}
