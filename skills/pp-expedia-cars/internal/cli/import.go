...
but do not stop the import.`,
  ...
  expedia-cars-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  expedia-cars-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | expedia-cars-pp-cli import <resource> --input -`,
